const menuItems = [
  { name: "Dirty Breakfast Bowl", category: "Breakfast Plates", url: "https://order.toasttab.com/online/dirty-breakfast/item-dirty-breakfast-bowl_8e91e52-b237-4001-aebe-7c35965f2554" },
  { name: "Dirty Breakfast Dish", category: "Breakfast Plates", url: "https://order.toasttab.com/online/dirty-breakfast/item-dirty-breakfast-dish_df9aafbe-e823-4cdd-94f9-a78e9afc0ba6" },
  { name: "Dirty Breakfast Burrito", category: "Breakfast Plates", url: "https://order.toasttab.com/online/dirty-breakfast/item-dirty-breakfast-burrito_7d0be39f-330e-4dc0-a9ac-3b7eeebd0651" },
  { name: "Dirty Breakfast French Toast", category: "Breakfast Plates", url: "https://order.toasttab.com/online/dirty-breakfast/item-dirty-breakfast-french-toast_39f30700-aa88-49b3-b170-9afbbd6be6cc" },
  { name: "Chick N Waffle", category: "Breakfast Plates", url: "https://order.toasttab.com/online/dirty-breakfast/item-chick-n-waffle_e3024cb-1c71-4912-b721-6363b3d81e1b" },
  { name: "Biscuits N Gravy", category: "Breakfast Plates", url: "https://order.toasttab.com/online/dirty-breakfast/item-biscuits-n-gravy_aadf7e6c-5bf2-44d8-b396-0edc2c6046f0" },
  ...
  { name: "Salmon Croquettes", category: "Entrees", url: "https://order.toasttab.com/online/dirty-breakfast/item-salmon-croquettes_4da1b5bb1-e07f-4a0f-a93b-ef9b78b66dfe" },
  { name: "Whiting", category: "Entrees", url: "https://order.toasttab.com/online/dirty-breakfast/item-whiting_e9fb1288-7a11-438b-9711-acbe5ef275af" },
  { name: "Pork Chops", category: "Entrees", url: "https://order.toasttab.com/online/dirty-breakfast/item-pork-chops_d00493fa-ac4f-9e9e-9ee2-539a6e15ad1c" },
  { name: "Lamb Chops", category: "Entrees", url: "https://order.toasttab.com/online/dirty-breakfast/item-lamb-chops_7fd685b5-1db4-8d2-9482-ecc5248519c6" },
  { name: "Ribeye", category: "Entrees", url: "https://order.toasttab.com/online/dirty-breakfast/item-ribeye_c3f36188-9241-4d6f-b77b-c445622c8162" },
  ...
  { name: "Hash Browns", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-hash-browns_6b7e0776-3d68-440f-a25e-d48784164eff" },
  { name: "Dirty Hash Browns", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-dirty-hash-browns_e8b0ffdc-f238-4c83-9a58-c0954151fdcf" },
  { name: "Grits", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-grits_31e353ff-8496-4e5a-beae-99b58b85bf4c" },
  { name: "Dirty Grits", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-dirty-grits_45dfdfcd-7197-40bb-8625-8786b77f1cf2" },
  { name: "Potatoes N Onions", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-potatoes-n-onions_1acc99ba-1c57-4fd8-a97a-19c8f7b444da" },
  { name: "Dirty Potatoes N Onions", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-dirty-potatoes-n-onions_4102065f-3b72-4a46-ab4d-d0e526ed9f59" },
  { name: "Green Beans", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-green-beans_6d44589a-b2ff-4797-92f5-bfb8d5ac8074" },
  { name: "Yams", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-yams_2609486e-f0a3-40ad-825e-0269567c0813" },
  { name: "Biscuit", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-biscuit_c44d210c-04b9-4b2f-ac5b-48ebbb500afc" },
  { name: "2 Eggs", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-2-eggs_7842a0b6-0c6e-4f60-8360-8d0491e584d4" },
  { name: "Pancakes", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-pancakes_bdb796ff-ba38-4d12-a794-17bee041e524" },
  { name: "Bacon", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-bacon_5e4ec946-3894-40be-8862-838b85e70437" },
  { name: "Sausage", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-sausage_b499100f-ba9a-44c9-a30a-fa902343bc3b" },
  { name: "Texas Toast", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-texas-toast-2_b9be661b-3922-40da-98af-d1777d99b87d" },
  { name: "Toast", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-toast-2_31d39d32-9771-4968-b6e6-304aacd4dc17" },
  { name: "Waffle", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-waffle_9cafed10-43a6-43bd-92e1-90bb38114853" },
  { name: "Shrimp (6)", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-6-shrimp_6b8c7070-ba3e-4303-941e-ef4924cdea55" },
  { name: "Gravy", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-gravy_c08156db-0eec-4b4e-8f7a-6281d5a622da" },
  { name: "Dirty Sauce", category: "Sides & Add-ons", url: "https://order.toasttab.com/online/dirty-breakfast/item-dirty-sauce_549ece8f-5c1d-4dbf-af0d-a48587a726f9" },
...
function getFiltered() {
  const filtered = menuItems.filter((item) => {
    ...
    const matchSearch = item.name.toLowerCase().includes(activeQuery.toLowerCase());
  ...
  if (activeSort === "category") {
    return filtered.sort((a, b) => `${a.category}${a.name}`.localeCompare(`${b.category}${b.name}`));
  }
          ...
          <div class="menu-cards">
            ${items
              .map((item) => {
                ...
                return `
                  <a class="menu-card" href="${item.url}" target="_blank" rel="noreferrer">
                    <div class="media">
                      ${
                        image
                          ? `<img src="${image}" alt="${item.name}" loading="lazy"/>`
                          : `<div class="placeholder">DIRTY PICK</div>`
                      }
                    </div>
                    <div class="body">
                      <h4>${item.name}</h4>
